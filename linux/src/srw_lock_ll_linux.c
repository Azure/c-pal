...
int srw_lock_ll_init(SRW_LOCK_LL* srw_lock_ll)
{
    ...
    {
        int ret;
        /* Codes_SRS_SRW_LOCK_LL_01_002: [ Otherwise, srw_lock_ll_init shall call pthread_rwlock_init. ] */
        ...
        {
            // Codes_SRS_SRW_LOCK_LL_11_003: [ srw_lock_ll_init shall succeed and return 0. ]
            result = 0;
        }
    }
    return result;
...
void srw_lock_ll_deinit(SRW_LOCK_LL* srw_lock_ll)
{
    ...
    {
        /* Codes_SRS_SRW_LOCK_LL_01_005: [ Otherwise, srw_lock_ll_deinit shall call pthread_rwlock_destroy and return. ] */
...
void srw_lock_ll_acquire_exclusive(SRW_LOCK_LL* srw_lock_ll)
{
    ...
    {
        /* Codes_SRS_SRW_LOCK_LL_01_007: [ srw_lock_ll_acquire_exclusive shall call pthread_rwlock_wrlock. ] */
...
SRW_LOCK_LL_TRY_ACQUIRE_RESULT srw_lock_ll_try_acquire_exclusive(SRW_LOCK_LL* srw_lock_ll)
{
    ...
    {
        /* Codes_SRS_SRW_LOCK_LL_01_009: [ Otherwise srw_lock_ll_try_acquire_exclusive shall call pthread_rwlock_trywrlock. ] */
        if (pthread_rwlock_trywrlock(srw_lock_ll) != 0)
        {
            /* Codes_SRS_SRW_LOCK_LL_01_011: [ If pthread_rwlock_trywrlock returns a non-zero value, srw_lock_ll_try_acquire_exclusive shall return SRW_LOCK_LL_TRY_ACQUIRE_COULD_NOT_ACQUIRE. ] */
            result = SRW_LOCK_LL_TRY_ACQUIRE_COULD_NOT_ACQUIRE;
        }
        else
        {
            /* Codes_SRS_SRW_LOCK_LL_01_010: [ If pthread_rwlock_trywrlock returns zero, srw_lock_ll_try_acquire_exclusive shall return SRW_LOCK_LL_TRY_ACQUIRE_OK. ] */
...
void srw_lock_ll_release_exclusive(SRW_LOCK_LL* srw_lock_ll)
{
    ...
    {
        /* Codes_SRS_SRW_LOCK_LL_01_013: [ srw_lock_ll_release_exclusive shall call pthread_rwlock_unlock. ] */
...
void srw_lock_ll_acquire_shared(SRW_LOCK_LL* srw_lock_ll)
{
    ...
    {
        /* Codes_SRS_SRW_LOCK_LL_01_015: [ srw_lock_ll_acquire_shared shall call pthread_rwlock_rdlock. ] */
...
SRW_LOCK_LL_TRY_ACQUIRE_RESULT srw_lock_ll_try_acquire_shared(SRW_LOCK_LL* srw_lock_ll)
{
    ...
    {
        /* Codes_SRS_SRW_LOCK_LL_01_017: [ Otherwise srw_lock_ll_try_acquire_shared shall call pthread_rwlock_tryrdlock. ] */
        if (pthread_rwlock_tryrdlock(srw_lock_ll) != 0)
        {
            /* Codes_SRS_SRW_LOCK_LL_01_018: [ If pthread_rwlock_tryrdlock returns a non-zero value, srw_lock_ll_try_acquire_shared shall return SRW_LOCK_LL_TRY_ACQUIRE_COULD_NOT_ACQUIRE. ] */
            result = SRW_LOCK_LL_TRY_ACQUIRE_COULD_NOT_ACQUIRE;
        }
        else
        {
            /* Codes_SRS_SRW_LOCK_LL_01_019: [ If pthread_rwlock_tryrdlock returns zero, srw_lock_ll_try_acquire_shared shall return SRW_LOCK_LL_TRY_ACQUIRE_OK. ] */
            result = SRW_LOCK_LL_TRY_ACQUIRE_OK;
        }
    }
...
void srw_lock_ll_release_shared(SRW_LOCK_LL* srw_lock_ll)
{
    ...
    {
        /* Codes_SRS_SRW_LOCK_LL_01_021: [ srw_lock_ll_release_shared shall call pthread_rwlock_unlock. ] */
