...
#ifdef USE_VALGRIND
    ANNOTATE_HAPPENS_BEFORE(addend);
#endif
    int32_t result = atomic_fetch_add(addend, value);
#ifdef USE_VALGRIND
    ANNOTATE_HAPPENS_AFTER(addend);
#endif
    return result + value;
}
...
IMPLEMENT_MOCKABLE_FUNCTION(, int64_t, interlocked_add_64, volatile_atomic int64_t*, addend, int64_t, value)
{
    ...
    ANNOTATE_HAPPENS_BEFORE(addend);
#endif
    int64_t result = atomic_fetch_add(addend, value);
#ifdef USE_VALGRIND
    ANNOTATE_HAPPENS_AFTER(addend);
#endif
    return result + value;
...
#endif
    int32_t result = atomic_fetch_and(destination, value);
#ifdef USE_VALGRIND
    ANNOTATE_HAPPENS_AFTER(destination);
#endif
    return result;
}
...
IMPLEMENT_MOCKABLE_FUNCTION(, int16_t, interlocked_and_16, volatile_atomic int16_t*, destination, int16_t, value)
{
    ...
    ANNOTATE_HAPPENS_BEFORE(destination);
#endif
    int16_t result = atomic_fetch_and(destination, value);
#ifdef USE_VALGRIND
    ANNOTATE_HAPPENS_AFTER(destination);
#endif
    return result;
...
IMPLEMENT_MOCKABLE_FUNCTION(, int64_t, interlocked_and_64, volatile_atomic int64_t*, destination, int64_t, value)
{
    ...
    ANNOTATE_HAPPENS_BEFORE(destination);
#endif
    int64_t result = atomic_fetch_and(destination, value);
#ifdef USE_VALGRIND
    ANNOTATE_HAPPENS_AFTER(destination);
#endif
    return result;
...
IMPLEMENT_MOCKABLE_FUNCTION(, int8_t, interlocked_and_8, volatile_atomic int8_t*, destination, int8_t, value)
{
    ...
    ANNOTATE_HAPPENS_BEFORE(destination);
#endif
    int8_t result = atomic_fetch_and(destination, value);
#ifdef USE_VALGRIND
    ANNOTATE_HAPPENS_AFTER(destination);
#endif
    return result;
...
IMPLEMENT_MOCKABLE_FUNCTION(, int32_t, interlocked_decrement, volatile_atomic int32_t*, addend)
{
    ...
    ANNOTATE_HAPPENS_BEFORE(addend);
#endif
    int32_t result = atomic_fetch_sub(addend, 1);
#ifdef USE_VALGRIND
    ANNOTATE_HAPPENS_AFTER(addend);
#endif
    return result - 1;
...
IMPLEMENT_MOCKABLE_FUNCTION(, int16_t, interlocked_decrement_16, volatile_atomic int16_t*, addend)
{
    ...
    ANNOTATE_HAPPENS_BEFORE(addend);
#endif
    int16_t result = atomic_fetch_sub(addend, 1);
#ifdef USE_VALGRIND
    ANNOTATE_HAPPENS_AFTER(addend);
#endif
    return result - 1;
...
IMPLEMENT_MOCKABLE_FUNCTION(, int64_t, interlocked_decrement_64, volatile_atomic int64_t*, addend)
{
    ...
    ANNOTATE_HAPPENS_BEFORE(addend);
#endif
    int64_t result = atomic_fetch_sub(addend, 1);
#ifdef USE_VALGRIND
    ANNOTATE_HAPPENS_AFTER(addend);
#endif
    return result - 1;
...
#ifdef USE_VALGRIND
    ANNOTATE_HAPPENS_BEFORE(target);
#endif
    int32_t result = atomic_exchange(target, value);
#ifdef USE_VALGRIND
    ANNOTATE_HAPPENS_AFTER(target);
#endif
    return result;
}
...
IMPLEMENT_MOCKABLE_FUNCTION(, int16_t, interlocked_exchange_16, volatile_atomic int16_t*, target, int16_t, value)
{
    ...
    ANNOTATE_HAPPENS_BEFORE(target);
#endif
    int16_t result = atomic_exchange(target, value);
#ifdef USE_VALGRIND
    ANNOTATE_HAPPENS_AFTER(target);
#endif
    return result;
...
IMPLEMENT_MOCKABLE_FUNCTION(, int64_t, interlocked_exchange_64, volatile_atomic int64_t*, target, int64_t, value)
{
    ...
    ANNOTATE_HAPPENS_BEFORE(target);
#endif
    int64_t result = atomic_exchange(target, value);
#ifdef USE_VALGRIND
    ANNOTATE_HAPPENS_AFTER(target);
#endif
    return result;
...
IMPLEMENT_MOCKABLE_FUNCTION(, void*, interlocked_exchange_pointer, void* volatile_atomic*, target, void*, value)
{
    ...
    ANNOTATE_HAPPENS_BEFORE(target);
#endif
    void* result = atomic_exchange(target, value);
#ifdef USE_VALGRIND
    ANNOTATE_HAPPENS_AFTER(target);
#endif
    return result;
...
IMPLEMENT_MOCKABLE_FUNCTION(, int16_t, interlocked_increment_16, volatile_atomic int16_t*, addend)
{
    ...
    ANNOTATE_HAPPENS_BEFORE(addend);
#endif
    int16_t result = atomic_fetch_add(addend, 1);
#ifdef USE_VALGRIND
    ANNOTATE_HAPPENS_AFTER(addend);
#endif
    return result + 1;
...
IMPLEMENT_MOCKABLE_FUNCTION(, int64_t, interlocked_increment_64, volatile_atomic int64_t*, addend)
{
    ...
    ANNOTATE_HAPPENS_BEFORE(addend);
#endif
    int64_t result = atomic_fetch_add(addend, 1);
#ifdef USE_VALGRIND
    ANNOTATE_HAPPENS_AFTER(addend);
#endif
    return result + 1;
...
IMPLEMENT_MOCKABLE_FUNCTION(, int32_t, interlocked_or, volatile_atomic int32_t*, destination, int32_t, value)
{
    ...
    ANNOTATE_HAPPENS_BEFORE(destination);
#endif
    int32_t result = atomic_fetch_or(destination, value);
#ifdef USE_VALGRIND
    ANNOTATE_HAPPENS_AFTER(destination);
#endif
    return result;
...
IMPLEMENT_MOCKABLE_FUNCTION(, int16_t, interlocked_or_16, volatile_atomic int16_t*, destination, int16_t, value)
{
    ...
    ANNOTATE_HAPPENS_BEFORE(destination);
#endif
    int16_t result = atomic_fetch_or(destination, value);
#ifdef USE_VALGRIND
    ANNOTATE_HAPPENS_AFTER(destination);
#endif
    return result;
...
IMPLEMENT_MOCKABLE_FUNCTION(, int64_t, interlocked_or_64, volatile_atomic int64_t*, destination, int64_t, value)
{
    ...
    ANNOTATE_HAPPENS_BEFORE(destination);
#endif
    int64_t result = atomic_fetch_or(destination, value);
#ifdef USE_VALGRIND
    ANNOTATE_HAPPENS_AFTER(destination);
#endif
    return result;
...
IMPLEMENT_MOCKABLE_FUNCTION(, int8_t, interlocked_or_8, volatile_atomic int8_t*, destination, int8_t, value)
{
    ...
    ANNOTATE_HAPPENS_BEFORE(destination);
#endif
    int8_t result = atomic_fetch_or(destination, value);
#ifdef USE_VALGRIND
    ANNOTATE_HAPPENS_AFTER(destination);
#endif
    return result;
...
IMPLEMENT_MOCKABLE_FUNCTION(, int32_t, interlocked_xor, volatile_atomic int32_t*, destination, int32_t, value)
{
    ...
    ANNOTATE_HAPPENS_BEFORE(destination);
#endif
    int32_t result = atomic_fetch_xor(destination, value);
#ifdef USE_VALGRIND
    ANNOTATE_HAPPENS_AFTER(destination);
#endif
    return result;
...
IMPLEMENT_MOCKABLE_FUNCTION(, int16_t, interlocked_xor_16, volatile_atomic int16_t*, destination, int16_t, value)
{
    ...
    ANNOTATE_HAPPENS_BEFORE(destination);
#endif
    int16_t result = atomic_fetch_xor(destination, value);
#ifdef USE_VALGRIND
    ANNOTATE_HAPPENS_AFTER(destination);
#endif
    return result;
...
IMPLEMENT_MOCKABLE_FUNCTION(, int64_t, interlocked_xor_64, volatile_atomic int64_t*, destination, int64_t, value)
{
    ...
    ANNOTATE_HAPPENS_BEFORE(destination);
#endif
    int64_t result = atomic_fetch_xor(destination, value);
#ifdef USE_VALGRIND
    ANNOTATE_HAPPENS_AFTER(destination);
#endif
    return result;
...
IMPLEMENT_MOCKABLE_FUNCTION(, int8_t, interlocked_xor_8, volatile_atomic int8_t*, destination, int8_t, value)
{
    ...
    ANNOTATE_HAPPENS_BEFORE(destination);
#endif
    int8_t result = atomic_fetch_xor(destination, value);
#ifdef USE_VALGRIND
    ANNOTATE_HAPPENS_AFTER(destination);
#endif
    return result;
