...
typedef void (*AIO_CALLBACK_FUNC)(sigval_t sv);

static FILE_HANDLE start_file_write_async(const unsigned char* buffer, uint32_t size, uint64_t position, FILE_CB user_callback, void* user_context, void** captured_aiocbp, AIO_CALLBACK_FUNC* captured_callback, sigval_t* captured_write_context)
{
...
static FILE_HANDLE start_file_read_async(unsigned char* buffer, uint32_t size, uint64_t position, FILE_CB user_callback, void* user_context, void** captured_aiocbp, AIO_CALLBACK_FUNC* captured_callback, sigval_t* captured_read_context)
{
    FILE_HANDLE file_handle = get_file_handle("test_file.txt");
