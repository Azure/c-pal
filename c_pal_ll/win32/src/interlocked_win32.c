...
int32_t interlocked_add(volatile int32_t* addend, int32_t value)
{
...
int32_t interlocked_and(volatile int32_t* destination, int32_t value)
{
...
int16_t interlocked_and_16(volatile int16_t* destination, int16_t value)
{
...
int64_t interlocked_and_64(volatile int64_t* destination, int64_t value)
{
...
int8_t interlocked_and_8(volatile int8_t* destination, int8_t value)
{
...
int32_t interlocked_compare_exchange(volatile int32_t* destination, int32_t exchange, int32_t comperand)
{
...
int16_t interlocked_compare_exchange_16(volatile int16_t* destination, int16_t exchange, int16_t comperand)
{
...
int64_t interlocked_compare_exchange_64(volatile int64_t* destination, int64_t exchange, int64_t comperand)
{
...
void* interlocked_compare_exchange_pointer(void* volatile* destination, void* exchange, void* comperand)
{
...
int32_t interlocked_decrement(volatile int32_t* addend)
{
...
int16_t interlocked_decrement_16(volatile int16_t* addend)
{
...
int64_t interlocked_decrement_64(volatile int64_t* addend)
{
...
int32_t interlocked_exchange(volatile int32_t* target, int32_t value)
{
...
int16_t interlocked_exchange_16(volatile int16_t* target, int16_t value)
{
...
int64_t interlocked_exchange_64(volatile int64_t* target, int64_t value)
{
...
int8_t interlocked_exchange_8(volatile int8_t* target, int8_t value)
{
...
int32_t interlocked_exchange_add(volatile int32_t* addend, int32_t value)
{
...
int64_t interlocked_exchange_add_64(volatile int64_t* addend, int64_t value)
{
...
void* interlocked_exchange_pointer(void* volatile* target, void* value)
{
...
int32_t interlocked_increment(volatile int32_t* addend)
{
...
int16_t interlocked_increment_16(volatile int16_t* addend)
{
...
int64_t interlocked_increment_64(volatile int64_t* addend)
{
...
int32_t interlocked_or(volatile int32_t* destination, int32_t value)
{
...
int16_t interlocked_or_16(volatile int16_t* destination, int16_t value)
{
...
int64_t interlocked_or_64(volatile int64_t* destination, int64_t value)
{
...
int8_t interlocked_or_8(volatile int8_t* destination, int8_t value)
{
...
int32_t interlocked_xor(volatile int32_t* destination, int32_t value)
{
...
int16_t interlocked_xor_16(volatile int16_t* destination, int16_t value)
{
...
int64_t interlocked_xor_64(volatile int64_t* destination, int64_t value)
{
...
int8_t interlocked_xor_8(volatile int8_t* destination, int8_t value)
{
