...
{
    /*Codes_SRS_JOB_OBJECT_HELPER_19_010: [job_object_set_job_limits_to_current_process shall succeed and return 0.] */
    int result = 0;

    /*Codes_SRS_JOB_OBJECT_HELPER_19_013: [ If percent_cpu is greater than 100 then job_object_helper_set_job_limits_to_current_process shall fail and return a non-zero value.] */
    /*Codes_SRS_JOB_OBJECT_HELPER_19_012: [ If percent_physical_memory is greater than 100 then job_object_helper_set_job_limits_to_current_process shall fail and return a non-zero value.] */
    if (percent_cpu > 100 || percent_physical_memory > 100)
    {
    ...
    {
        /*Codes_SRS_JOB_OBJECT_HELPER_19_014: [ If percent_cpu and percent_physical_memory are 0 then job_object_helper_set_job_limits_to_current_process shall succeed and return 0.] */
        if (percent_cpu == 0 && percent_physical_memory == 0)
        {
            /*Codes_SRS_JOB_OBJECT_HELPER_19_011: [job_object_helper_set_job_limits_to_current_process shall call CloseHandle to close the handle of the Job object.] */
            result = 0;
        }
        else
        {
