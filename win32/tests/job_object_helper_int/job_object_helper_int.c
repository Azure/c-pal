...
#include "geo_helpers/job_object_helper.h"
...
/*Tests_SRS_JOB_OBJECT_HELPER_18_001: [ If percent_physical_memory is 0, job_object_helper_limit_resources_single_call shall fail and return a non-zero value. ]*/
TEST_FUNCTION(job_object_helper_limit_resources_single_call_called_with_0_memory)
{
    // arrange

    // act
    int result = job_object_helper_limit_resources_single_call(0, test_percent_cpu);

    // assert
    ASSERT_ARE_NOT_EQUAL(int, 0, result);
}

/*Tests_SRS_JOB_OBJECT_HELPER_18_002: [ If percent_cpu is 0, job_object_helper_limit_resources_single_call shall fail and return a non-zero value. ]*/
TEST_FUNCTION(job_object_helper_limit_resources_single_call_called_with_0_cpu)
{
    // arrange

    // act
    int result = job_object_helper_limit_resources_single_call(test_percent_physical_memory, 0);

    // assert
    ASSERT_ARE_NOT_EQUAL(int, 0, result);
}

/*Tests_SRS_JOB_OBJECT_HELPER_18_004: [ If percent_physical_memory is greater than 100, job_object_helper_limit_resources_single_call shall fail and return a non-zero value. ]*/
TEST_FUNCTION(job_object_helper_limit_resources_single_call_called_with_101_memory)
{
    // arrange

    // act
    int result = job_object_helper_limit_resources_single_call(101, test_percent_cpu);

    // assert
    ASSERT_ARE_NOT_EQUAL(int, 0, result);
}

/*Tests_SRS_JOB_OBJECT_HELPER_18_005: [ If percent_cpu is greater than 100, job_object_helper_limit_resources_single_call shall fail and return a non-zero value. ]*/
TEST_FUNCTION(job_object_helper_limit_resources_single_call_called_with_101_cpu)
{
    // arrange

    // act
    int result = job_object_helper_limit_resources_single_call(test_percent_physical_memory, 101);

    // assert
    ASSERT_ARE_NOT_EQUAL(int, 0, result);
}

static void setup_job_object_helper_limit_resources_single_call_expected_calls()
{
...
/*Tests_SRS_JOB_OBJECT_HELPER_18_009: [ job_object_helper_limit_resources_single_call shall call GlobalMemoryStatusEx to get the total amount of physical memory in kb. ]*/
/*Tests_SRS_JOB_OBJECT_HELPER_18_006: [ job_object_helper_limit_resources_single_call shall call CreateJobObject to create a new job object passing NULL for both lpJobAttributes and lpName. ]*/
/*Tests_SRS_JOB_OBJECT_HELPER_18_007: [ job_object_helper_limit_resources_single_call shall call GetCurrentProcess to get the current process handle. ]*/
/*Tests_SRS_JOB_OBJECT_HELPER_18_008: [ job_object_helper_limit_resources_single_call shall call AssignProcessToJobObject to assign the current process to the new job object. ]*/
/*Tests_SRS_JOB_OBJECT_HELPER_18_010: [ job_object_helper_limit_resources_single_call shall call SetInformationJobObject, passing JobObjectExtendedLimitInformation and a JOBOBJECT_EXTENDED_LIMIT_INFORMATION object with JOB_OBJECT_LIMIT_JOB_MEMORY set and JobMemoryLimit set to the percent_physical_memory percent of the physical memory in bytes. ]*/
/*Tests_SRS_JOB_OBJECT_HELPER_18_011: [ job_object_helper_limit_resources_single_call shall call SetInformationJobObject passing JobObjectCpuRateControlInformation and a JOBOBJECT_CPU_RATE_CONTROL_INFORMATION object with JOB_OBJECT_CPU_RATE_CONTROL_ENABLE and JOB_OBJECT_CPU_RATE_CONTROL_HARD_CAP set, and CpuRate set to percent_cpu times 100. ]*/
/*Tests_SRS_JOB_OBJECT_HELPER_18_012: [ job_object_helper_limit_resources_single_call shall call CloseHandle to close the handle of the current process. ]*/
/*Tests_SRS_JOB_OBJECT_HELPER_18_013: [ job_object_helper_limit_resources_single_call shall call CloseHandle to close the handle to the job object. ]*/
/*Tests_SRS_JOB_OBJECT_HELPER_18_014: [ job_object_helper_limit_resources_single_call shall succeed and return 0. ]*/
TEST_FUNCTION(job_object_helper_limit_resources_single_call_succeeds)
{
    // arrange
    setup_job_object_helper_limit_resources_single_call_expected_calls();

    // act
    int result = job_object_helper_limit_resources_single_call(test_percent_physical_memory, test_percent_cpu);
...
/*Tests_SRS_JOB_OBJECT_HELPER_18_015: [ If there are any failures, job_object_helper_limit_resources_single_call shall fail and return a non-zero value. ]*/
TEST_FUNCTION(job_object_helper_limit_resources_single_call_fails)
{
    // arrange
    setup_job_object_helper_limit_resources_single_call_expected_calls();
